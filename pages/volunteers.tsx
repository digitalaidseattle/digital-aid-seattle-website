...
const expectationsContent = [
  {
    label: 'Skill',
    content:
      'You demonstrate proficiency in your craft and operate with both autonomy and transparency.',
    icon: StarsOutlined,
  },
  {
    label: 'Experience',
    content:
      'You are a seasoned professional, capable of leading yourself and others in your discipline.',
    icon: WorkHistoryOutlined,
  },
  {
    label: 'Availability',
    content:
      'You dedicate 4 hours a week for at least 6 months to accomplish your committed tasks with Digital Aid Seattle.',
